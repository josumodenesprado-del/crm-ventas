...
const Layout = () => {
  ...
  const navItems = [
    ...
    { path: '/leads/webs', label: 'Leads Web', icon: 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9' },
    { path: '/leads/clinicas', label: 'Leads Clínicas', icon: 'M4.8 2.3A.3.3 0 105 2H4a2 2 0 00-2 2v5a6 6 0 006 6v0a6 6 0 006-6V4a2 2 0 00-2-2h-1a.2.2 0 10.3.3M8 15v1a6 6 0 006 6v0a6 6 0 006-6v-4M20 10V6a2 2 0 00-2-2h-1a.3.3 0 10.3.3' },
  ];
